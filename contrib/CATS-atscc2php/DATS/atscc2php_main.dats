...
#dynload "./atscc2php_emit.dats"
#dynload "./atscc2php_emit2.dats"
...
then let
  val () =
  prerrln! ("atscc2php: there is a reported error.")
in
  // nothing
end // end of [then]
else if
...
then let
  val () =
  prerrln! ("atscc2php: there are some reported errors.")
in
  // nothing
end // end of [then]
else () // end of [else]
